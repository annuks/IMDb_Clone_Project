// code to getting the movie list alredy added in favourite list
function getFavLIst() {
...
//function to add movie  to the favourite list
function addMovieToFavContainer(movie) {
  ...
  let movieContainer = document.getElementById(
    "favourite-movie-list-container"
  );
  let movieHTML = ` <div class="search-movie-card">
    ...
    <div  class="search-movie-image"><a href="./moviepage.html?movie=${
      movie.imdbID
