...
async function movieDetail(movie) {
  ...
  let movieHTML = `<div id="movie-container">
    ...
    <div id="movie-detail-container">
        ...
        <div id="movie-detail">
            <div id="title-container-detail"><b style="font-size: xx-large;"> ${
              movie.Title
            } </b> | ${movie.Year} | ${movie.Rated} </div>
            <div id="releasing-year"><b>Release date: </b>${movie.Released}</p>
            
            <div class="movie-item-detail"><b>Genre :</b> ${movie.Genre}</div>
            <div class="movie-item-detail"><b>Runtime :</b> ${
              movie.Runtime
            }</div>
            <div class="movie-item-detail"><b>Language :</b> ${
              movie.Language
            }</div>
            <div class="movie-item-detail"><b>Director :</b> ${
              movie.Director
            }</div>
            ...
            <div id="rating-movie-detail">
                <div>
                    IMDB Rating : <i class="fa-solid fa-star" style="color: #ff9e04;"></i> ${
                      movie.imdbRating
                    }/10
                </div>
                <div>
            ...
            <div class="movie-item-detail"><b>BoxOffice :</b> ${
              movie.BoxOffice
            }</div>
